                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="nominal" class="form-control" value="{{ old('nominal', $keuangan->nominal) }}" min="0" required style="border-radius:0 12px 12px 0;">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kategori" class="form-select">
                            ...
                            <option value="Kas"    {{ old('kategori', $keuangan->kategori) == 'Kas'    ? 'selected' : '' }}>Kas</option>
                            <option value="Iuran"  {{ old('kategori', $keuangan->kategori) == 'Iuran'  ? 'selected' : '' }}>Iuran</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kode_kegiatan" class="form-select">
                            ...
                            @foreach($kegiatans as $k)
                                <option value="{{ $k->kode_kegiatan }}" {{ old('kode_kegiatan', $keuangan->kode_kegiatan) == $k->kode_kegiatan ? 'selected' : '' }}>
                                    {{ $k->nama_kegiatan }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="keterangan" class="form-control" rows="2">{{ old('keterangan', $keuangan->keterangan) }}</textarea>
                    </div>
                </div>
